...
data(i).name = 'Emax ECO II Series 2207 2400KV, prop. 5x4.3x3';
data(i).r = 5 * in2m;
...
% from g to Netwons
data(i).thrust_g = [67	80	90	101	115	128	145	160	196	236	288	346	417	482	558	621	709	788	858	928	985	1029 1050];
